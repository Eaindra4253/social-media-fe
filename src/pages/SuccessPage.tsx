...
import { Container, Title, Text, Box, Stack, Card, Alert, Space, ActionIcon } from '@mantine/core';
import { IconAlertTriangle, IconCheck, IconArrowLeft } from '@tabler/icons-react';
